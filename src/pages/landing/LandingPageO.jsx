      ...
      <nav className="relative z-50 px-6 md:px-12 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            <Link
              to="/party"
              className="hidden md:block px-4 py-2 font-bold text-black hover:bg-black hover:text-yellow-400 rounded-xl transition-colors border-2 border-black"
            >
              파티 찾기
            </Link>
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  {ottLogos.slice(0, 3).map((ott, i) => (
                    <div key={i} className="flex items-center justify-between p-3 bg-gray-100 rounded-xl border-2 border-black">
