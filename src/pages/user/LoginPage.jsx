  ...
  return (
    <div className="flex flex-col items-center pt-28 pb-20">
      ...
      <div className="w-full max-w-md space-y-3 mt-10">
        ...
        {/* ✅ 카카오 로그인 (SVG 아이콘 적용 - 이미지 깨짐 방지) */}
        <button
          id="btnKakaoLogin"
          onClick={handleKakaoLogin}
          className="w-full h-[45px] bg-[#FEE500] hover:bg-[#FDD835] rounded-[6px] flex items-center justify-center relative transition-colors"
        >
          <div className="absolute left-[14px]">
             {/* 카카오 로고 SVG */}
             <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 3C5.925 3 1 6.925 1 11.775C1 14.1375 2.525 16.275 4.9375 17.775L4.2875 20.2125C4.1625 20.675 4.675 21.0625 5.0875 20.7875L8.525 18.5125C9.625 18.7875 10.7875 18.925 12 18.925C18.075 18.925 23 15 23 10.15C23 5.3 18.075 3 12 3Z" fill="#000000" fillOpacity="0.9"/>
             </svg>
          </div>
        ...
        {/* ✅ Google 로그인 (SVG 아이콘 적용 - 공식 스타일) */}
        <button
          id="btnGoogleLogin"
          onClick={handleGoogleLogin}
          className="w-full h-[45px] bg-white border border-[#dadce0] hover:bg-[#f8faff] rounded-[6px] flex items-center justify-center relative transition-colors"
        >
